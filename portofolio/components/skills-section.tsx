...
const skills = [
  {
    ...
    level: 90,
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full fill-[#61dafb] drop-shadow-sm">
  ...
  },
  {
    ...
    level: 85,
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full fill-white drop-shadow-sm">
  ...
  },
  {
    ...
    level: 80,
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full fill-[#3178c6] drop-shadow-sm">
  ...
  },
  {
    ...
    level: 75,
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full fill-[#68a063] drop-shadow-sm">
        <path d="M12 2L2 7v10l10 5 10-5V7l-10-5zm0 2.18l7.84 4.11v8.16l-7.84 4.11-7.84-4.11v-8.16L12 4.18zm0 2.82c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4z" />
      </svg>
    ),
  ...
  },
  {
    ...
    level: 95,
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full fill-[#06b6d4] drop-shadow-sm">
