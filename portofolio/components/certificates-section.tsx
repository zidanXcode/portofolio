            ...
            {certificates.map((cert, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-primary/95 backdrop-blur-md px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-bold text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-lg">
                    Cert {index + 1}
                  </div>
                </div>
              </div>
